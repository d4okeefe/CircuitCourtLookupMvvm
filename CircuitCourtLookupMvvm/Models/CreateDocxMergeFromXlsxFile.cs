...
{
    internal class CreateDocxMergeFromXlsxFile
    {
        public CreateDocxMergeFromXlsxFile(string sourceSpreadsheet, string sourseTemplate, string destinationWordFile)
        {
            // create app object
