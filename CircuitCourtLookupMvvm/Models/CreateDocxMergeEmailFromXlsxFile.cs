...
{
    internal class CreateDocxMergeEmailFromXlsxFile
    {
        public CreateDocxMergeEmailFromXlsxFile(string sourceSpreadsheet, string sourseTemplate, string destinationWordFile)
        {
            // create app object
